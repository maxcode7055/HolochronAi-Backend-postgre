...
#                                             'if': {
#                                                 '$or': [
#                                                     {'$regexMatch': {'input': '$$item.file', 'regex': '^http://'}},
#                                                     {'$regexMatch': {'input': '$$item.file', 'regex': '^https://'}}
#                                                 ]
#                                             },
#                                             'then': '$$item.file',
#                                             'else': {'$concat': [os.getenv("IMAGE_URL"), "/images/", '$$item.file']}
#                                         }
#                                     }
#                                 }
#                             ]
